              ...
              <AnimatePresence mode="wait">
                {activeTab === "home" && (
                  <motion.div
                    ...
                    animate="enter"
                    exit="exit"
                    className="min-h-full flex flex-col relative z-10"
                  >
                    {/* Hero Section */}
                          ...
                          >
                            <div className="space-y-6">
                              <motion.div
                                ...
                                className="text-sm uppercase tracking-wider text-cyan-400 code"
                              >
                                HOME
                              </motion.div>
                              ...
                              >
                                <div className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl leading-tight tracking-tight">
                                  <TypingAnimation 
                                    text="Hi, I'm Sandra Demition" 
                                    delay={2000} 
                                    speed={60}
                                    className="teal-text-primary font-bold"
                                  />
                                </div>
                                <motion.div 
                                  className="text-2xl md:text-3xl lg:text-4xl text-muted mt-4"
                                  initial={{ opacity: 0, y: 20 }}
                                  animate={{ opacity: 1, y: 0 }}
                            ...
                            >
                              ...
                              with creativity and aesthetics. Specializing in video editing, social media 
                              strategy, and modern web experiences.
                            </motion.p>
                                ...
                                >
                                  <div className="flex items-center gap-3 mb-2">
                                    <div className={`w-2 h-2 rounded-full ${
                                      ...
                                      service.color === 'blue' ? 'bg-blue-400' : 'bg-emerald-400'
                                    }`}></div>
                                    <span className={`code text-sm ${
                                      service.color === 'teal' ? 'text-teal-400' :
                                      service.color === 'cyan' ? 'text-cyan-400' :
                                      service.color === 'blue' ? 'text-blue-400' : 'text-emerald-400'
                    }`}>
                                      {service.title}
                                    </span>
                                  </div>
                  ...
                  >
                    <div className="bg-[#1e2832]/70 rounded-xl p-6 sm:p-8 w-full backdrop-filter backdrop-blur-md">
                      ...
                      <div className="space-y-6 text-left">
                        ...
                        <div className="space-y-6">
                          <motion.h2 
                            className="text-3xl teal-text-primary"
                          ...
                          >
                            <p>
                              ...
                              <span className="teal-text-accent"> video editing</span>, <span className="teal-text-accent">social media management</span>, 
                              and <span className="teal-text-accent">web content design</span>. Over the past few years, I've worked with different 
                              brands and agencies across <span className="text-cyan-300">Canada, the US, and Australia</span>, helping them grow their 
                              presence online through engaging visuals, campaigns, and storytelling.
                            </p>
                            
                            <p>
                              I'm the type of person who enjoys both the <span className="teal-text-accent">creative and technical sides</span> of digital work. 
                              Whether it's editing podcasts and videos, designing a Shopify page, or running social media campaigns, I like bringing 
                              ideas to life and making content that people connect with.
                            </p>
                            
                            <p>
                              I'd say my strengths are being <span className="text-cyan-300">resourceful</span>, <span className="text-cyan-300">adaptable</span>, 
                              and <span className="text-cyan-300">always curious</span>. I love learning new tools and trends that make content stand out. 
                              At the end of the day, I just enjoy creating things that make an impact, whether it's for a brand, a business, or a community.
                            </p>
                          </motion.div>
                  ...
                  >
                    ...
                    >
                      ...
                      <p className="text-muted max-w-2xl mx-auto">
                        Professional creative services that drive results and exceed expectations.
                      </p>
                    </motion.div>
                      ...
                      {services.map((service, index) => (
                        <motion.div
                          ...
                          className={`bg-[#1e2832]/70 rounded-xl p-6 text-center transition-all duration-300 backdrop-filter backdrop-blur-md ${
                            service.color === 'teal' ? 'teal-glow' :
                            service.color === 'cyan' ? 'cyan-glow' :
                            service.color === 'blue' ? 'blue-glow' : 'emerald-glow'
                          } hover:shadow-lg`}
                        >
                          <div className={`w-16 h-16 mx-auto mb-4 rounded-lg ${
                            service.color === 'teal' ? 'bg-teal-500/10' :
                            service.color === 'cyan' ? 'bg-cyan-500/10' :
                            service.color === 'blue' ? 'bg-blue-500/10' : 'bg-emerald-500/10'
                          } flex items-center justify-center`}>
                            <span className="text-3xl">{service.icon}</span>
                          </div>
                          <h4 className="text-xl mb-3 capitalize">
                ...
                {activeTab === "portfolio" && (
                  <motion.div
                    ...
                    animate="enter"
                    exit="exit"
                    className="p-4 sm:p-8 max-w-7xl mx-auto relative z-10"
                  >
                    <motion.div 
                      className="text-center mb-8 sm:mb-12"
                      initial={{ opacity: 0, y: -20 }}
                    ...
                    >
                      ...
                      <p className="text-muted max-w-2xl mx-auto">
                        A collection of projects showcasing expertise across multiple creative disciplines.
                      </p>
                    </motion.div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-16">
                      {projects.map((project, index) => (
                        ...
                        >
                            ...
                            >
                              ...
                              <div className="absolute top-4 left-4">
                                <span className={`dev-badge ${
                                  ...
                                  project.status === 'Live' ? 'badge-cyan' :
                                  project.status === 'Trending' ? 'badge-orange' :
                                  'badge-blue'
                                }`}>
                                  {project.status}
                                </span>
                          ...
                          <div className="p-6">
                            <h3 className="text-xl mb-2 group-hover:teal-text-primary transition-colors duration-300">
                              {project.title}
                            </h3>
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                              {project.tech.slice(0, 3).map((tech, techIndex) => (
                                <span
                                  key={techIndex}
                                  className="code text-xs bg-teal-900/20 text-teal-300 px-2 py-1 rounded"
                                >
                                  {tech}
                                </span>
                              ))}
                            ...
                            <div className="flex gap-2">
                              <Button
                                size="sm"
                                className="dev-button text-teal-400 hover:bg-teal-500/5 flex-1"
                              >
                                View Project
                              </Button>
                            </div>
                ...
                {activeTab === "certificates" && (
                  <motion.div
                    ...
                    animate="enter"
                    exit="exit"
                    className="py-8 px-4 sm:p-8 max-w-7xl mx-auto relative z-10 min-h-screen"
                  >
                    {/* Header Section */}
                    <motion.div 
                      className="text-center mb-8 sm:mb-12"
                    ...
                    >
                      ...
                      <p className="text-muted max-w-2xl mx-auto">
                        Google Professional Certificates demonstrating expertise in digital marketing, UX design, and project management.
                      </p>
                    </motion.div>
                      ...
                      {certificates.map((certificate, index) => (
                        ...
                        >
                          ...
                          <div className="relative group overflow-hidden">
                            ...
                            >
                              <img
                                ...
                                alt={`${certificate.title} - Sandra Demition`}
                                className="w-full h-full object-cover"
                                loading="lazy"
                              />
                              ...
                              <div className="absolute top-4 left-4">
                                <span className={`dev-badge ${
                                  certificate.color === 'teal' ? 'badge-primary' :
                                  certificate.color === 'cyan' ? 'badge-cyan' : 'badge-blue'
                                }`}>
                                  ✅ Google Verified
                                </span>
                              </div>
                              ...
                              <div className="absolute bottom-4 right-4">
                                <span className="code text-xs bg-teal-900/30 text-teal-300 px-3 py-2 rounded backdrop-blur-sm">
                          ...
                          <div className="p-6">
                            ...
                            <h3 className="text-lg mb-3 teal-text-primary leading-tight">
                              {certificate.title}
                            </h3>
                            ...
                            <div className="flex flex-wrap gap-2 mb-4">
                              ...
                              {certificate.skills.length > 2 && (
                                <span className="code text-xs bg-cyan-900/20 text-cyan-400 px-2 py-1 rounded">
                            ...
                            <Button
                              size="sm"
                              className="dev-button text-teal-400 hover:bg-teal-500/5 w-full"
                      ...
                      <div className="bg-[#1e2832]/70 rounded-xl p-6 sm:p-8 backdrop-filter backdrop-blur-md max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                          <div className="code text-xs sm:text-sm text-left bg-[#0f1419]/90 p-4 sm:p-6 rounded-lg">
                            ...
                            <div className="mt-3 space-y-1 sm:space-y-2">
                              <div><span className="syntax-keyword">total_certificates</span>: <span className="syntax-number">3</span></div>
                              <div><span className="syntax-keyword">certification_provider</span>: <span className="syntax-string">"Google Career Certificates"</span></div>
                              <div><span className="syntax-keyword">platform</span>: <span className="syntax-string">"Coursera"</span></div>
                              <div><span className="syntax-keyword">completion_year</span>: <span className="syntax-number">2020</span></div>
                              <div><span className="syntax-keyword">status</span>: <span className="syntax-string">"verified"</span></div>
                              <div><span className="syntax-keyword">professional_development</span>: <span className="syntax-string">"ongoing"</span></div>
                            </div>
                          </div>
                          ...
                          <div className="code text-xs sm:text-sm text-left bg-[#0f1419]/90 p-4 sm:p-6 rounded-lg">
                            ...
                            <div className="mt-3 space-y-1 sm:space-y-2">
                              <div><span className="syntax-keyword">digital_marketing</span>: <span className="syntax-string">"E-commerce & Analytics"</span></div>
                              <div><span className="syntax-keyword">user_experience</span>: <span className="syntax-string">"Design & Research"</span></div>
                              <div><span className="syntax-keyword">project_management</span>: <span className="syntax-string">"Agile & Scrum"</span></div>
                              <div><span className="syntax-keyword">industry_ready</span>: <span className="syntax-string">true</span></div>
                              <div><span className="syntax-keyword">career_advancement</span>: <span className="syntax-string">"enterprise_level"</span></div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="mt-4 sm:mt-6">
                          <p className="text-xs sm:text-sm text-muted max-w-4xl mx-auto">
                            All certificates are verified through Google Career Certificates program and demonstrate 
                            industry-ready skills for professional roles in digital marketing, UX design, and project management.
                            Each certificate represents comprehensive training and hands-on project experience.
                          </p>
                        </div>
                      </div>
                    </motion.div>
                      ...
                      <div className="text-center space-y-8">
                        ...
                        >
                          ...
                          <p className="text-muted max-w-lg mx-auto">
                            Got an idea in mind? Let's chat about your project and turn it into something amazing together.
                          </p>
                        </motion.div>
                        ...
                        >
                          <div className="code text-sm text-left bg-[#0f1419]/90 p-4 rounded-lg">
                            ...
                            <div className="mt-2 space-y-1">
                              <div><span className="syntax-keyword">email</span>: <span className="syntax-string">"sandrademition@gmail.com"</span></div>
                              <div><span className="syntax-keyword">linkedin</span>: <span className="syntax-string">"/in/sandra-demition"</span></div>
                              <div><span className="syntax-keyword">status</span>: <span className="syntax-string">"available"</span></div>
                              <div><span className="syntax-keyword">response_time</span>: <span className="syntax-string">"24h"</span></div>
                            </div>
                          </div>
                        </motion.div>
                        ...
                        >
                          <Button 
                            className="dev-button text-teal-400 hover:bg-teal-500/5 px-8 py-3"
                            onClick={() => window.open('mailto:sandrademition@gmail.com', '_blank')}
                          >
                            📧 Send Email
                          </Button>
                          <Button 
                            className="dev-button text-cyan-400 hover:bg-teal-500/5 px-8 py-3"
                            onClick={() => window.open('https://www.linkedin.com/in/sandra-demition-8a455b114', '_blank')}
                          >
                            💼 LinkedIn
                          </Button>
                        </motion.div>
